...
FRPCLIB="libfrpc_1N_<company>_<one digit sequence>_<cpu|gpu>.so"
root=$(pwd)
approot=$root/bin
libroot=$root/lib
...
# pass into Makefile
numLibs=$(ls $libroot/libfrpc_1N_*_?_[cg]pu.so | wc -l)
...
libstring=$(ls $libroot/libfrpc_1N_*_?_[cg]pu.so)
