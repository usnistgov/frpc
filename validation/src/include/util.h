...
/** @brief This function reads a PPM file into a FRPC::Image data
 * structure
 *
 * @param[in] file
 * Path to image file
 * @param[out] image
 * The populated FRPC::Image data structure with raw image data
 ...
 */
bool
readImage(const std::string &file, FRPC::Image &image);

/** @brief This function converts a FRPC::ReturnCode
 * to a readable string
 *
 * @param[in] code
 * ReturnCode
 ...
 */
const char*
to_string(FRPC::ReturnCode code);
